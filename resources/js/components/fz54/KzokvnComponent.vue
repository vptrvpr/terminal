            ...
            <div class="container">
                <transition name="showDiv2">
                    <div class="infomation_about" v-if="showDiv2">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <h1 class="h1-fz text-center">Как зарегистрировать онлайн-кассу в налоговой</h1>
                            ...
                            <div class="col-md-12">
                                <div id="bx_689919819_2430">
                                    <p>
                                        ...
                                        не так сложно, как кажется. Ниже мы расскажем, <strong>как зарегистрировать
                                        онлайн-кассу в налоговой</strong>, и дадим пошаговую инструкцию регистрации ККТ
                                    ...
                                    <h4>Шаг 1. Подача заявления на регистрацию ККТ и получение регистрационного номера
                                        ККТ.</h4>
                                    <p>
                                        На главной странице личного кабинета откройте вкладку <span
                                        style="font-weight:bold">Учет контрольно-кассовой техники</span>.
                                    </p>
                                    <p>
                                        <img width="465" alt="001.png" src="/upload/medialibrary/001.png" height="215"
                                             title="001.png"><br>
                                    </p>
                                    <p>
                                        ...
                                        <span style="font-weight:bold">Зарегистрировать ККТ</span> и выберите <span
                                        style="font-weight:bold">Заполнить параметры заявления вручную</span>.
                                    </p>
                                    <p>
                                        <img width="490" alt="002.png" src="/upload/medialibrary/002.png" height="241"
                                             title="002.png"><br>
                                    </p>
                                    <p>
                                    ...
                                    <p>
                                        ...
                                        кнопку <span style="font-weight:bold">Выбрать адрес</span>. Заполните
                                        открывшуюся форму. Индекс подставится автоматически. В поле <span
                                        style="font-weight:bold">Наименование места установки ККТ</span> опишите место
                                        более подробно. Затем введите информацию о модели своей ККТ. Нажмите кнопку
                                        <span style="font-weight:bold">Выбрать модель ККТ</span> и выберите модель из
                                        списка.
                                    </p>
                                    <p>
                                        ...
                                        ККТ. Введите номер в поле и нажмите кнопку <span style="font-weight:bold">Выбрать</span>.
                                    </p>
                                    <p>
                                    ...
                                    <p>
                                        <img width="478" alt="003.png" src="/upload/medialibrary/003.png" height="292"
                                             title="003.png"><br>
                                    </p>
                                    <p>
                                        Нажмите кнопку <span style="font-weight:bold">Подписать и отправить</span>.
                                    ...
                                    <p>
                                        ...
                                        или откройте раздел <span style="font-weight:bold">Информация о прохождении документов, направленных в налоговый орган</span>.
                                        Здесь отображаются все документы, которые отправлялись с данной КЭП. Проверьте
                                        статус документа <span style="font-weight:bold">Заявление о регистрации</span>.
                                    </p>
                                    <p>
                                        <img width="459" alt="005.png" src="/upload/medialibrary/005.png" height="190"
                                             title="005.png"><br>
                                    </p>
                                    <p>
                                        Когда заявление будет обработано, на главной странице кабинета налогоплательщика
                                        снова войдите в раздел <span style="font-weight:bold">Учет контрольно-кассовой техники</span>.
                                    </p>
                                    <p>
                                    ...
                                    <p>
                                        ...
                                        перейдите на вкладку <span style="font-weight:bold">История заявлений</span> и
                                        скачайте PDF-документ.
                                    </p>
                                    <p>
                                        <img width="458" alt="007.png" src="/upload/medialibrary/007.png" height="246"
                                             title="007.png"><br>
                                    </p>
                                    ...
                                    <p>
                                        <img width="778" alt="00777.png" src="/upload/medialibrary/00777.png"
                                             height="291" title="00777.png"><br>
                                    </p>
                                    <p>
                                    ...
                                    <p>
                                        <img width="500" alt="util-1.1.png" src="/upload/medialibrary/util-1.1.png"
                                             height="347" title="util-1.1.png"><br>
                                    </p>
                                    <p>
                                        Если ККМ подключена по USB, то она определится сама. Если под другим интерфейсом
                                        — зайдите в настройки и укажите параметры подключения. Нажмите <span
                                        style="font-weight:bold">Зарегистрировать</span>.
                                    </p>
                                    <p>
                                        <img width="500" alt="util-2.png" src="/upload/medialibrary/util-2.png"
                                             height="347" title="util-2.png"><br>
                                    </p>
                                    <p>
                                        Проверьте дату и время. Если они отличаются от времени на компьютере, то
                                        проведите синхронизацию. Если совпадают — нажмите <span
                                        style="font-weight:bold">Далее</span> для перехода на вкладку ввода параметров.
                                    </p>
                                    <p>
                                    ...
                                    <p>
                                        <img width="374" alt="021.png" src="/upload/medialibrary/021.png" height="298"
                                             title="021.png"><br>
                                    </p>
                                    <p>
                                        Впишите параметры вашего ОФД. Нажмите <span
                                        style="font-weight:bold">Далее</span>.
                                    </p>
                                    <p>
                                        <img width="500" alt="util-5.png" src="/upload/medialibrary/util-5.png"
                                             height="347" title="util-5.png"><br>
                                    </p>
                                    <p>
                                        На следующей вкладке укажите систему налогообложения. Можно выбрать сразу
                                        несколько вариантов. Нажмите <span style="font-weight:bold">Далее</span>.
                                    </p>
                                    <p>
                                        <img width="500" alt="util-6.png" src="/upload/medialibrary/util-6.png"
                                             height="347" title="util-6.png"><br>
                                    </p>
                                    <p>
                                        Проверьте правильность введенной информации. Если есть ошибка, нажмите <span
                                        style="font-weight:bold">Назад&nbsp;</span>и внесите правки. Если все в порядке,
                                        нажмите <span style="font-weight:bold">Выполнить</span>.
                                    </p>
                                    <p>
                                        Происходит регистрация ККТ. Отчет о регистрации будет напечатан на чеке.
                                    </p>
                                    <p>
                                        <img width="300" alt="11.PNG" src="/upload/medialibrary/11.PNG" height="377"
                                             title="11.PNG"><br>
                                    </p>
                                    <p>
                                        Вернитесь в личный кабинет налогоплательщика на сайте nalog.ru. Нажмите кнопку
                                        <span style="font-weight:bold">Завершить регистрацию</span>. Заполните
                                        открывшуюся форму <span style="font-weight:bold">Отчет о регистрации ККТ</span>.
                                        Используйте данные отчета, напечатанного на чеке при фискализации кассы.&nbsp;
                                    </p>
                                    <p>
                                        <img width="500" alt="00888.png" src="/upload/medialibrary/00888.png"
                                             height="266" title="00888.png">
                                    </p>
                                    <p>
                                    ...
                                    <p>
                                        ...
                                        налогоплательщика в разделе <span style="font-weight:bold">«Информация о прохождении документов, отправленных в налоговый орган»</span>.
                                    </p>
                                    <h3>Шаг 3. Карточка регистрации ККТ</h3>
                                    <p>
                                        После регистрации кассы в личном кабинете налогоплательщика в разделе <span
                                        style="font-weight:bold">Информация о прохождении документов, направленных в налоговый орган</span>,
                                    ...
                                    <p>
                                        Откройте вкладку ККТ, выберите <span
                                        style="font-weight:bold">Подключить ККТ</span>.
                                    </p>
                                    <p>
                                        В открывшемся окне <span style="font-weight:bold">Регистрация ККТ</span>
                                        заполните все поля.
                                    </p>
                                    <p>
                                        <img width="497" alt="OFDreg1.jpg" src="/upload/medialibrary/OFDreg1.jpg"
                                             height="294" title="OFDreg1.jpg"><br>
                                    </p>
                                    <p>
                                    ...
                                    <p>
                                        В поле <span style="font-weight:bold">Внутреннее наименование ККТ</span> можно
                                        присвоить ФР произвольное имя.
                                    </p>
                                    <p>
                                        <img width="450" alt="OFDreg2.jpg" src="/upload/medialibrary/OFDreg2.jpg"
                                             height="287" title="OFDreg2.jpg"><br>
                                    </p>
                                    <p>
                                        Нажмите <span style="font-weight:bold">Сохранить</span>. Появится сообщение об
