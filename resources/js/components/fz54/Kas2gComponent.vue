                            ...
                            <div class="col-md-12">
                                <div id="bx_689919819_2430">
                                    <p>
                                        ...
                                        техники»: <strong>с 2018 года введение кассовых аппаратов </strong> затрагивает
                                    ...
                                    <ul>
                                        <li>оказывает услуги населению, оформляя их бланками строгой отчетности.
                                            Подробнее о требованиях к БСО — здесь &gt;&gt;
                                        </li>

                                        <li>применяет ЕНВД и ПСН, работает в рознице или общепите и не имеет наемных
                                            сотрудников.
                                        </li>
                                    </ul>
                                    <p>
                                    ...
                                    <ul>
                                        <li>Изменено понятие расчетов. Теперь к ним относится не только движение
                                            денежных средств, но и зачет предоплаты и получение за товар других вещей.
                                        </li>
                                        <li>После получения онлайн-платежа чек нужно сформировать не позднее следующего
                                            рабочего дня.
                                        </li>
                                        <li> С 1 июля 2019 года при зачете предоплаты нужно будет пробивать два чека:
                                        ...
                                        <li>Предпринимателей и компании на спецрежимах (УСН, ЕНВД и патент) будут
                                        ...
                                        <li>Зарегистрировать ККМ с 2017 года можно через интернет — это удобно и быстро.
                                            Подробнее о регистрации кассы &gt;&gt;
                                        </li>
                                        <li>Если предприниматель не будет соблюдать требования 54-ФЗ, ему грозит штраф
                                    ...
                                    <p>
                                        ...
                                        предпринимателей — а их более 1 млн! </p>
                                    <p>
                                    </p>
                                    <p>
                                    </p>
                                    ...
                                    <h2>Как новые правила будут работать в труднодоступных местностях, где нет
                                        интернета?</h2>
                                    <p>
