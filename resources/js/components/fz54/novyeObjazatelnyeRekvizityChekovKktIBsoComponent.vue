            ...
            <div class="container">
                <transition name="showDiv2">
                    <div class="infomation_about" v-if="showDiv2">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <h1 class="h1-fz text-center">Обязательные реквизиты кассового чека и БСО в 2019
                                    году</h1>
                            ...
                            <div class="col-md-12">
                                <div id="bx_689919819_1349">
                                    <p>
                                        ...
                                        отчетности. Данные ОФД, к которому подключена онлайн-касса, включены в <strong>обязательные
                                        реквизиты БСО и кассового чека в 2019 году</strong>. В документах теперь надо
                                        указывать разные параметры. В чеках нужно пробивать наименования товаров, для
                                        этого необходима кассовая программа, которая это умеет.
                                    </p>
                                    <p>
                                    ...
                                    <img src="https://www.moysklad.ru/upload/medialibrary/aca/Чек_наш.jpg" Бланки=""
                                         строгой="" отчетности="" должны="" быть="" изготовлены="" типографским=""
                                         способом="" или="" сформированы="" с="" использованием="" автоматизированных=""
                                         систем.="" Если="null" вы="" печатаете="" БСО="null" в="" то="" такие=""
                                         бланки="" содержать="" сведения="" об="" изготовителе:="" сокращенное=""
                                         номер="" заказа="" и="" год="" его="" тираж.="" p="">
                                    <p>
