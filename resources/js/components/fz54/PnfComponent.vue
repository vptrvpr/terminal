            ...
            <div class="container">
                <transition name="showDiv2">
                    <div class="infomation_about" v-if="showDiv2">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <h1 class="h1-fz text-center">Переход на ФФД 1.05 и НДС 20%: АТОЛ, ШТРИХ-М, Viki
                                    Print</h1>
                            ...
                            <div class="col-md-12">
                                <div id="bx_689919819_2430">
                                    ...
                                    <div class="alert alert-warning">
                                        ...
                                        ожидаемая схема работы такая:<br>
                                        <br>
                                        ...
                                        1.01.19) — вам нужно использовать ставку НДС 20%.<br>
                                        <br>
                                        ...
                                        потребуется вашему клиенту или вам (то есть оформить в виде скидки).<br>
                                        <br>
                                        — Возврат товаров, которые были проданы в 2018 году, но возвращены будут в 2019,
                                        надо будет делать по ставке НДС 18%.
                                    </div>
                                    <p>
                                        <strong>Важно!</strong> Перейти на новую ставку НДС необходимо строго к 1
                                    ...
                                    <div class="alert alert-warning">
                                        ...
                                        компании (<strong>Меню пользователя</strong> — <strong>Настройки</strong> —
                                        <strong>Справочники</strong> — <strong>Юр. лица</strong>) должно быть отмечено,
                                        что вы платите НДС.
                                    </div>
                                    <p>
                                    ...
                                    <ol>
                                        <li>Проверьте версию ФФД на кассе. Если 1.0 — требуется апгрейд. Если 1.05 —
                                            ничего менять не нужно!
                                        </li>
                                        <li>Проверьте, платите ли вы НДС. Если да — приготовьтесь менять прошивку кассы.
                                    ...
                                    <ul type="square">
                                        <li>Найдите на сайте ШТРИХ-М в разделе Продукты свою модель кассы, откройте
                                        ...
                                        <li>Выполните отчет о перерегистрации. Это можно сделать через драйвер ККТ или
                                    ...
                                    <ul>
                                        ...
                                        <li>Убедитесь, что все ранее сформированные фискальные документы переданы в
                                            ОФД.
                                        </li>
                                        <li>Скачайте, установите и запустите приложение Утилита регистрации ККТ АТОЛ.
                                        ...
                                        <li>Подайте заявление о перерегистрации ККТ в ФНС. Это можно сделать на сайте
                                            ФНС.
                                        </li>
                                    </ul>
                                    ...
                                    <ul>
                                        <li>В офисе сервисного партнера АТОЛ: для этого вам понадобится привезти туда
                                            кассу.
                                        </li>
                                        <li>В месте установки кассовой техники: для этого вызовите к себе инженера,
                                            чтобы он настроил вашу кассу.
                                        </li>
                                        <li>Дистанционно — с помощью облачных инструментов АТОЛ Сервис. Компания АТОЛ
                                    ...
                                    <h3>Как быть с арендуемыми кассами АТОЛ? Когда можно обновить прошивку и куда
                                        обратиться?</h3>
                                    <p>
                                    ...
                                    <h3>Почему на чеках пишется строка про НДС под каждым товаром, если я не использую
                                        НДС? Можно ее убрать?</h3>
                                    <p>
                                    ...
                                    <h3>Кассу регистрировали с ФФД 1.05, при распечатке тест-листа версия ФФД ФН — 1.0.
                                        В какой версии работает ФН?</h3>
                                    <p>
                                    ...
                                    <h3>Для каких случаев автоматически поменяется ставка, если ставка у товара явно не
                                        указана?</h3>
                                    <p>
