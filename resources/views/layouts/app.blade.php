...
<head>
    ...
    <link rel="stylesheet" href="{{ env('MIX_URL_SITE') }}/css/style.css?13">
...
<script src="{{ env('MIX_URL_SITE') }}/js/app.js?13"></script>
<script src="{{ env('MIX_URL_SITE') }}/js/custom.js?13"></script>
