...
<head>
    ...
    <link rel="stylesheet" href="{{ env('MIX_URL_SITE') }}/css/style.css?1112234512111222223112">
...
<script src="{{ env('MIX_URL_SITE') }}/js/app.js?1112234512111222223112"></script><!-- /#wrapper -->
