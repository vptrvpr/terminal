...
<head>
    ...
    <link rel="stylesheet" href="{{ env('MIX_URL_SITE') }}/css/style.css?111223451211122222311">
...
<script src="{{ env('MIX_URL_SITE') }}/js/app.js?111223451211122222311"></script><!-- /#wrapper -->
