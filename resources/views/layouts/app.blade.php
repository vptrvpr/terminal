...
<head>
    ...
    <link rel="stylesheet" href="{{ env('MIX_URL_SITE') }}/css/style.css?1112234512111222223112122">
...
<script src="{{ env('MIX_URL_SITE') }}/js/app.js?111223451211122222311212"></script><!-- /#wrapper -->
